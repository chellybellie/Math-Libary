...
void SpaceshipRenderer::draw(const mat3 & T, const Transform & ship)
{
	...
	sfw::drawLine(backR.x, backR.y, backL.x, backL.y, BLUE);
	sfw::drawLine(backL.x, backL.y, R.x, R.y, BLUE);
	sfw::drawLine(center.x, center.y, backL.x, backL.y, BLUE);
	sfw::drawLine(centerL.x, centerL.y, L2.x, L2.y, BLUE);
	sfw::drawLine(centerR.x, centerR.y, R2.x, R2.y, BLUE);


	sfw::drawLine(R.x, R.y, R1.x, R1.y, color);
	sfw::drawLine(R1.x, R1.y, R2.x, R2.y, color);
	sfw::drawLine(R2.x, R2.y, R3.x, R3.y, BLUE);
